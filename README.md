...
* Perl scripts [no_mask.pl](https://github.com/parthian-sterlet/antinoise/blob/main/src/no_mask.pl) and [mask.pl](https://github.com/parthian-sterlet/antinoise/blob/main/src/mask.pl) and respective command lines [no_mask_run](https://github.com/parthian-sterlet/antinoise/blob/main/src/no_mask_run) and [mask_run](https://github.com/parthian-sterlet/antinoise/blob/main/src/mask_run) show example application of the genomic approach for the background generation for a tested annotation of peaks in BED format without and with application of additional annotation of blacklisted regions of a genome in BED format
