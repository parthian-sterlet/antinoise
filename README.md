...
## Scripts to run AntiNoise starting from the reference genome in PLAIN format
...
## Scripts to run AntiNoise starting from the reference genome in FASTA format
