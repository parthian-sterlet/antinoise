...
* No masking
Perl scripts [no_mask_pl](https://github.com/parthian-sterlet/antinoise/blob/main/src/no_mask.pl) shows the example application of the genomic approach for the background generation for a tested annotation of peaks in BED format. Background sequences are seach
* blacklists masking
