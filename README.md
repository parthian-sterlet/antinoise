...
Perl script [mask_whitelisted.pl](https://github.com/parthian-sterlet/antinoise/blob/main/src/mask_whitelisted.pl) shows the example application of the genomic approach for the background generation for a tested annotation of peaks in BED format with application of additional annotation of 'whitelisted' regions of a genome in BED format, i.e. only these regions will proceed to output data, all the rest genomic regions will be masked. The file contains promoter regions (5 kb upstream and 100 bp downstream) regions of mouse protein coding genes [mm10_m5kb_p100_pc.bed](https://github.com/parthian-sterlet/antinoise/blob/main/whitelisted/mm10_m5kb_p100_pc.bed) based on annotation fro  Genecode [version M25](https://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_mouse/release_M25/).
