...
my ($cmd, $path_exe, $path_in, $path_out, $bed_whitelist_file, $genome, $genome_fa, $bed_chipseq_file);
my ($bed_whitelist_file_sorted, $bed_whitelist_file_sorted_no_over, $bedext, $chr, $backext, $faext,$bederr);
...
$bed_whitelist_file= $ARGV[4]; # BED file, whitelist regions
...
$bed_whitelist_file_sorted = "whitelist_sorted";
$bed_whitelist_file_sorted_no_over = "whitelist_sorted_no_over";
...
$cmd= "$path_exe/bed_sort.exe ${path_out}${bed_whitelist_file} ${path_out}${bed_whitelist_file_sorted}${bedext} ${genome}";
print "$cmd\n";
system $cmd;

$cmd= "$path_exe/bed_chr_separation.exe ${path_out}${bed_whitelist_file_sorted}${bedext} ${path_out}${bed_whitelist_file_sorted} ${genome}";
print "$cmd\n";
system $cmd;

$cmd= "$path_exe/area_self_overlap.exe ${path_out}${bed_whitelist_file_sorted} ${path_out}${bed_whitelist_file_sorted_no_over} ${genome}";
print "$cmd\n";
system $cmd;

$cmd= "$path_exe/bed_chr_mask.exe ${path_in} ${path_out} ${bed_whitelist_file_sorted_no_over} ${chr} ${chr} 1 ${genome}";
print "$cmd\n";
system $cmd;
